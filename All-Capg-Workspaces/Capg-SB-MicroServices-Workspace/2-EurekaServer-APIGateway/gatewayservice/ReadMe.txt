...
4. For Loans -  http://localhost:8989/loans
5. For Demat Accounts -  http://localhost:8989/demataccounts
6. For Customer 
	1. getAllCust - http://localhost:8989/customer/getallcust
	2. getCustById - http://localhost:8989/customer/getcust/101
	3. addCust - http://localhost:8989/customer/addcust  with JSON object
